...
<html>
<head>
      <title>Fact behind name</title>
       <style>img[alt="www.000webhost.com"]{display :none;} </style>
       <meta name="viewport" content="width=device-width, initial-scale=1.0">
</head>
<body>
  <br>
  <h2 align="center">Know Your Fact</h2>
  <table align="center"  >

    <form  enctype="multipart/form-data" method="POST" action="show.php">
    
    <tr><th><input type="text" name="name" placeholder="Enter Your Name" required></th></tr>
    <tr><th><br></th></tr>
    <br>
...
<!-- Mirrored from rokpatel.000webhostapp.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Apr 2020 13:20:16 GMT -->
...
<!--===============================================================================================-->  
  <link rel="icon" type="file/png" href="files/icons/favicon.ico"/>
<!--===============================================================================================-->
...
<body>
  ...
  <div class="limiter">
    <div class="container-login100" style="background-file: url('files/bg-01.jpg');">
      <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
        <form class="login100-form validate-form flex-sb flex-w" action="show.php" method="POST">
        <!--  <span class="login100-form-title p-b-53">
            Know Your Name Fact</span> --> 
            <h1 align="center">Know Your Name Fact</h1>
          <div class="p-t-31 p-b-9">
            <span class="txt1" aling="">
              Enter Your Name
            </span>
          </div>
